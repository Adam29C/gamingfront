        ...
        <app-deposit-withdraw _nghost-fig-c63="">
          <div className="deposit_withdrawal">
            <h2 className="userscreen-title">
              <Link className="btn-xs deposit-btn" to={"/"}>
                Back
              </Link>
            </h2>
                            ...
                            <div className="card-body">
                              <form id="amountForm" method="post">
                                <input
                                  type="hidden"
                                  name="_token"
                                  defaultValue="rqPdb3mnZMrLuhY1Gp7ChsBSW30FnTEif5wtCkrf"
                                />
